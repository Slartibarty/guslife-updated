...
#define	NUM_OTIS_HEADS	3	// four heads available for otis model
enum { HEAD_MALLCOP = 0, HEAD_YOUNG = 1, HEAD_COP = 2 };
...
Schedule_t slOtEnemyDraw[] = 
{
	{
		tlOtEnemyDraw,
		ARRAYSIZE ( tlOtEnemyDraw ),
		0,
		0,
		"Barney Enemy Draw"
	}
...
void COtis :: BarneyFirePistol ( void )
{
	...
	short pitchShift = RANDOM_LONG( 0, 20 );
...
void COtis :: TalkInit()
{
	...
	{
	default:
	case HEAD_MALLCOP	:	m_voicePitch = 100; break;	//glasses
	case HEAD_YOUNG		:	m_voicePitch = 105; break;	//einstein
	case HEAD_COP		:	m_voicePitch = 95;  break;	//luther
	}
}
